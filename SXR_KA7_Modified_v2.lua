...
--// SXR KA7 CUSTOM PATCH
local UIS = game:GetService("UserInputService")

local SizePresets = {
    UDim2.new(0, 350, 0, 240),
    UDim2.new(0, 380, 0, 260),
    UDim2.new(0, 410, 0, 280),
    UDim2.new(0, 440, 0, 300),
    UDim2.new(0, 470, 0, 320),
    UDim2.new(0, 520, 0, 340),
    UDim2.new(0, 560, 0, 360),
    UDim2.new(0, 600, 0, 380),
    UDim2.new(0, 680, 0, 420),
    UDim2.new(0, 760, 0, 470),
    UDim2.new(0, 840, 0, 520)
}

local MainGui = game:GetService("CoreGui"):FindFirstChildWhichIsA("ScreenGui")

if MainGui then
    local MainFrame = MainGui:FindFirstChildWhichIsA("Frame", true)

    if MainFrame then
        MainFrame.Size = SizePresets[6]

        local OpenCloseButton = Instance.new("ImageButton")
        OpenCloseButton.Name = "ToggleUI"
        OpenCloseButton.Parent = MainGui
        OpenCloseButton.Size = UDim2.new(0,45,0,45)
        OpenCloseButton.Position = UDim2.new(0,15,0.5,-20)
        OpenCloseButton.BackgroundColor3 = Color3.fromRGB(15,15,15)
        OpenCloseButton.BorderSizePixel = 2
        OpenCloseButton.Image = "rbxassetid://87950815567502"

        local Corner = Instance.new("UICorner", OpenCloseButton)
        ...
        local CloseButton = MainFrame:FindFirstChild("X", true) or MainFrame:FindFirstChildWhichIsA("TextButton", true)
        ...
        if CloseButton then
            ...
            ConfirmFrame.Size = UDim2.new(0,170,0,85)
            ConfirmFrame.Position = UDim2.new(0.5,-85,0.5,-42)
            ...
            CloseScript.Parent = ConfirmFrame
            CloseScript.Size = UDim2.new(0,70,0,28)
            CloseScript.Position = UDim2.new(0,10,1,-38)
            CloseScript.Text = "Close"
            CloseScript.TextColor3 = Color3.new(1,1,1)
            CloseScript.BackgroundColor3 = Color3.fromRGB(30,30,30)
            CloseScript.BorderSizePixel = 2

            local CancelButton = Instance.new("TextButton")
            CancelButton.Parent = ConfirmFrame
            CancelButton.Size = UDim2.new(0,70,0,28)
            CancelButton.Position = UDim2.new(1,-80,1,-38)
            CancelButton.Text = "Cancel"
            CancelButton.TextColor3 = Color3.new(1,1,1)
            CancelButton.BackgroundColor3 = Color3.fromRGB(30,30,30)
            CancelButton.BorderSizePixel = 2

            local c1 = Instance.new("UICorner", CloseScript)
            c1.CornerRadius = UDim.new(0,6)

            local c2 = Instance.new("UICorner", CancelButton)
