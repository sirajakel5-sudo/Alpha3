...
pcall(function()
	...
	local Sizes = {
		...
		UDim2.new(0,400,0,250),
		UDim2.new(0,450,0,280),
		UDim2.new(0,500,0,300),
		UDim2.new(0,550,0,320),

		UDim2.new(0,650,0,380),
		UDim2.new(0,700,0,420),
		UDim2.new(0,750,0,450),

		UDim2.new(0,850,0,520),
		UDim2.new(0,950,0,600),
	...
	SizeFrame.Size = UDim2.new(0,120,0,360)
	SizeFrame.Position = UDim2.new(1,-130,0.5,-180)
	SizeFrame.BackgroundColor3 = Color3.fromRGB(15,15,15)
	SizeFrame.BorderSizePixel = 0

	local FrameCorner = Instance.new("UICorner")
	FrameCorner.Parent = SizeFrame
	FrameCorner.CornerRadius = UDim.new(0,8)

	local UIList = Instance.new("UIListLayout")
	UIList.Parent = SizeFrame
